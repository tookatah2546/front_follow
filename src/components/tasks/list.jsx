    ...
    return(
        <>
            <div class="grid grid-rows-1 grid-flow-row gap-1">
                <div className="border bg-primary rounded-lg my-2 px-5 w-full h-11 flex flex-row justify-between">
                    <p className="my-2">pb1.ui1</p>
                    <div className="flex flex-row justify-end ">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 my-2 mr-5 ">
                    ...
                    <div className="border bg-yellow rounded-lg my-2 px-5 w-full h-11 flex flex-row justify-between">
                    <p className="my-2">pb1.ui2</p>
                    <div className="flex flex-row justify-end ">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 my-2 mr-5 ">
                        <path stroke-linecap="round" stroke-linejoin="round" d="m16.862 4.487 1.687-1.688a1.875 1.875 0 1 1 2.652 2.652L6.832 19.82a4.5 4.5 0 0 1-1.897 1.13l-2.685.8.8-2.685a4.5 4.5 0 0 1 1.13-1.897L16.863 4.487Zm0 0L19.5 7.125" />
                        </svg>
